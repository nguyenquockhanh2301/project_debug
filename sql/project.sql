...
-- Created time: Oct 01, 2024 at 02:33 AM
...
--
-- Loading data to table `order_items`
--
...
CREATE TABLE `users` (
  ...
  `role` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'USER'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
--
-- Constraints for the `products` table
--
ALTER TABLE `products`
